...
export default function MobileNav(props: MobileNavProps) {
  return (
    <div className='navbar-menu fixed bottom-0 left-0 top-0 z-40 w-1/2 max-w-sm'>
      <div
        className='bg-slate navbar-backdrop fixed inset-0 opacity-50'
        onClick={props.onClick}
      ></div>
      <nav className='bg-slate relative flex h-full w-full flex-col overflow-y-auto border-r px-10 py-8'>
        <Link href='/'>
